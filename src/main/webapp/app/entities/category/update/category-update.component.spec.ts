  ...
  describe('Category Management Update Component', () => {
    ...
    describe('ngOnInit', () => {
      it('Should call Category query and add missing value', () => {
        ...
        const parent: ICategory = { id: 24103 };
        category.parent = parent;

        const categoryCollection: ICategory[] = [{ id: 96124 }];
      ...
      it('Should call Product query and add missing value', () => {
        const category: ICategory = { id: 456 };
        const products: IProduct[] = [{ id: 85001 }];
      ...
      it('Should update editForm', () => {
        const category: ICategory = { id: 456 };
        const parent: ICategory = { id: 18566 };
        category.parent = parent;
        const products: IProduct = { id: 41751 };
        category.products = [products];
